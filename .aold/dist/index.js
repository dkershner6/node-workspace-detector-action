...
const find_package_json_1 = __importDefault(__webpack_require__(127));
const findPackageJson = () => {
    const originalPath = process.cwd();
    const resultIterator = find_package_json_1.default(originalPath);
    const firstResult = resultIterator.next();
    const resultFilePath = firstResult.filename;
    if (!resultFilePath) {
        core_1.setFailed('No package.json found');
        return;
    }
    core_1.info(`Found at ${resultFilePath}`);
...
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = __webpack_require__(470);
const findPackageJson_1 = __importDefault(__webpack_require__(170));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = findPackageJson_1.default();
            core_1.setOutput('workspace', result);
        }
        catch (error) {
